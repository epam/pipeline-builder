parser grammar WdlDraft1Parser;

options { tokenVocab=WdlDraft1Lexer; }
...
workflow_output_fqn_part
  : STAR
  | Identifier (DOT workflow_output_fqn_part)*
  ;
...
workflow_output
  : OUTPUT LBRACE (workflow_output_fqn (COMMA workflow_output_fqn)* COMMA?)* RBRACE
  ;
